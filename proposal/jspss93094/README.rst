...
1. When the function is updated to the certain degree, I will upload the new version both to the google drive and github branch.
2. when it updated, the contents of updating details will show in the update.txt file.
3.In order to control the version branch, I will let all versions of the same function save in the different directory.
